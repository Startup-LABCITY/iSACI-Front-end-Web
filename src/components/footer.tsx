        ...
        <footer className="relative border-t border-border bg-background pt-16 pb-8 overflow-hidden">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4 pb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-4">
                                ...
                                <div className="h-8 w-8 rounded-full bg-primary/10 flex items-center justify-center text-primary hover:bg-primary hover:text-primary-foreground transition-all cursor-pointer">
                    ...
                    {/* Institucional */}
                    <div className="space-y-6">
                        <h3 className="text-[13px] font-bold text-foreground uppercase tracking-widest bg-primary/5 w-fit px-3 py-1 rounded-md">Institucional</h3>
                    ...
                    {/* Projetos */}
                    <div className="space-y-6">
                        <h3 className="text-[13px] font-bold text-foreground uppercase tracking-widest bg-primary/5 w-fit px-3 py-1 rounded-md">Nossa Atuação</h3>
                        <ul className="space-y-3">
                    ...
                    {/* Contato */}
                    <div className="space-y-6">
                        <h3 className="text-[13px] font-bold text-foreground uppercase tracking-widest bg-primary/5 w-fit px-3 py-1 rounded-md">Contato Direto</h3>
                        <ul className="space-y-5">
                            <li className="flex items-start gap-3 group">
                                <div className="h-9 w-9 rounded-xl bg-primary/10 flex items-center justify-center shrink-0 border border-primary/20 group-hover:bg-primary transition-colors">
